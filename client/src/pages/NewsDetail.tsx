...
import { getInitialLocale, getLocaleDirection, type Locale } from "@/lib/locale";
...
export default function NewsDetail() {
  ...
  useEffect(() => {
    ...
    document.title = `${item.title} | ${locale === "ar" ? "نبض العالم" : "Global Pulse"}`;
