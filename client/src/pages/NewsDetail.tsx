...
export const EDITORIAL_VALUE_HEADINGS = {
  context: "السياق التحريري",
  verification: "ما الذي نتحقق منه؟",
  readingNote: "ملاحظة للقراءة",
} as const;

export const AI_SUMMARY_LABEL = "ملخص مولّد بمساعدة الذكاء الاصطناعي";
export const ORIGINAL_CONTENT_NOTE = "محتوى الخبر يُعرض كما يتيحه المصدر، مع الإحالة الواضحة إلى المصدر الأصلي ودون ادعاء أنه مادة تحريرية مستقلة.";
export const EDITORIAL_LEAD = "مهندس علي";
export const IMAGE_SOURCE_NOTE = "الصورة: من المصدر المرتبط بالخبر؛ لا تُعاد مراسلتها أو استخدامها خارج سياق الإحالة دون التحقق من الترخيص.";
