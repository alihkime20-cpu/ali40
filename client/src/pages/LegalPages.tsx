...
const pages = {
  about: {
    ...
    sections: [
      ...
      { h: EDITORIAL_SECTION_HEADINGS.organization, p: "نبض العالم مشروع إخباري رقمي مستقل يدار تحريرياً من العراق، ويهتم بأخبار العراق والشرق الأوسط إلى جانب الأخبار العالمية. نعمل على عرض المعلومات بوضوح، ونوضح للقارئ مصدر كل خبر بدلاً من تقديمه كمادة أصلية من دون إحالة." },
