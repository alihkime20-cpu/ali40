...
async def post_init(application: Application):
    application.bot_data["news_task"] = asyncio.create_task(news_loop(application.bot_data["repo"]))
...
def main():
    ...
    app.add_handler(CommandHandler("start", start)); app.add_handler(CommandHandler("admin", admin_command)); app.add_handler(CommandHandler("help", help_command)); app.add_handler(CommandHandler("search", search_command)); app.add_handler(CallbackQueryHandler(callback)); app.add_error_handler(on_error)
