...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not url:
        await update.message.reply_text("أرسل رابط TikTok أو Instagram صالحًا."); return
    ...
    try:
        ...
        logger.exception("Video delivery failed")
        await status.edit_text("❌ تعذر إرسال الفيديو. قد يكون حجمه أكبر من حد Telegram.")
    finally:
