...
export function registerSeoRoutes(app: Express) {
  ...
  app.get("/sitemap.xml", (req, res) => { const origin = siteOrigin(req); const paths = [
    ["/", "daily", "1.0"], ["/tools", "weekly", "0.9"], ["/tools/image-compressor", "weekly", "0.8"], ["/tools/image-converter", "weekly", "0.8"], ["/tools/merge-pdf", "weekly", "0.8"], ["/about", "yearly", "0.4"], ["/contact", "yearly", "0.4"], ["/privacy", "yearly", "0.3"], ["/terms", "yearly", "0.3"], ["/cookies", "yearly", "0.3"], ["/content-policy", "yearly", "0.3"],
